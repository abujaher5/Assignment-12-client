...
const ErrorPage = () => {
  return (
    <section className="bg-white text-center flex items-center justify-center min-h-screen">
      <div className="">
        <div className="w-full ">
          <p className=" text-4xl md:text-7xl font-medium text-gray-500">
            404 error
          </p>
          <h1 className="mt-3 text-2xl font-semibold text-gray-800 dark:text-white md:text-6xl">
            Page not found
          </h1>
          <p className="mt-4 text-xl md:text-3xl text-gray-500 dark:text-gray-400">
